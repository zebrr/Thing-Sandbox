...
**Задачи:**
- Разработать промпты Phase 1:
  - Системная инструкция для персонажа
  - User prompt с контекстом (память, локация, другие персонажи)
  - Требования к выходу (IntentionResponse schema)

**Примечание:** Ручное тестирование во время работы над demo-sim вне плана.

**Ожидаемый результат:**
- Файлы промптов готовы

**Артефакты:**
- Промпт (system): `src/prompts/phase1_intention_system.md`
- Промпт (user): `src/prompts/phase1_intention_user.md`
...
**Задачи:**
- Разработать промпты Phase 2a (арбитр):
  - Инструкция для арбитра (Game Master)
  - User prompt с локацией, персонажами, намерениями
  - Требования к выходу (Master.schema.json)
- Разработать промпты Phase 2b (нарратив):
  - Инструкция для генерации нарратива
  - User prompt с результатом арбитра + контекст
...
**Артефакты:**
- Промпт 2a (system): `src/prompts/phase2a_resolution_system.md`
- Промпт 2a (user): `src/prompts/phase2a_resolution_user.md`
- Промпт 2b (system): `src/prompts/phase2b_narrative_system.md`
- Промпт 2b (user): `src/prompts/phase2b_narrative_user.md`
...
**Задачи:**
- Разработать промпты Phase 4:
  - Инструкция для суммаризации памяти
  - User prompt со старым summary + выпадающая ячейка
...
**Артефакты:**
- Промпт (system): `src/prompts/phase4_summary_system.md`
- Промпт (user): `src/prompts/phase4_summary_user.md`
