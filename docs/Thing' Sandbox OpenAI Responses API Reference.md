# OpenAI Responses API Reference - Thing' Sandbox v1.0 upd.2025-11-30
...
{
  "model": "gpt-5.1",
  "input": "Analyze the conflict between these characters and determine the outcome...",
  "reasoning": {
    "effort": "medium",
    "summary": "concise"
  },
...
{
  "model": "gpt-5.1",
  "input": "Continue the scene based on previous events...",
  "previous_response_id": "resp_abc123",
  "instructions": "Maintain consistency with established context.",
  "max_output_tokens": 4096
}
```

### Background запрос для параллельной обработки

```json
{
  "model": "gpt-5-mini",
  "input": "Process this location scene independently...",
  "background": true,
  "max_output_tokens": 4096,
  "store": false
}
...
```python
# Быстрая генерация (низкая latency)
fast_config = {
    "model": "gpt-4.1-mini",
    "temperature": 0.7,
